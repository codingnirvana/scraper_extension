...
com.codewired.indix.extension.prototype = {
    ...
    showNotification: function (iFrameAddress, notification, overridingStylesheet) {
        chrome.extension.sendRequest({ topic: 'shownotification', title:'Price: $98:50', message: 'Okie Dokie' });
...
com.codewired.indix.currentPage.prototype = {
  ...
  scrapePage: function(scrapeCallback) {
    ...
    var scrapeHandler = function(html) {
        var s = new com.codewired.indix.common.htmlScraper(html, self.retailer, self.browser);
...
com.codewired.indix.products = function(extension, options) {
  ...
  this.notification = new com.codewired.indix.notification(extension.browser, extension, this.retailers);
}
...
com.codewired.indix.products.prototype = {
  ...
  run: function() {
    ...
    self.scrapeCurrentPage(function(err, currentPage) {
      self.notification.sendCurrentPage("guid", currentPage);
    });
  }
}
